...
if __name__ == "__main__":
    ...
    star_time = time.time()
    test_dataset = MyDataset('/mnt/10T/zjy/database/OIQ_10k/OIQ-10k_resize_1024','/mnt/10T/wkc/New_model/oiq_10k_info_alter.csv',mode='train',transform=test_transform)
